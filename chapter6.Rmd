...
observation, i.e., the values obtained by subtracting the relevant occasion mean from the original observation and then dividing by the corresponding visit standard deviation. Next we standardise the variable "Weight" with "Time" as grouping variable, glimpse the data with standadised weight, and plot it.
```{r}
library(dplyr)
library(tidyr)
